...
// /api/sync cron, every 10 minutes per vercel.json — see vercel.json and
// SETUP_AND_VERIFY.md). Polling every 30 seconds catches every sync run within
// half a minute — effectively identical UX to a push-based subscription, for
// a fraction of the moving parts. If the sync interval ever gets tightened to
// near-real-time, drop the interval below to match.
//
